                    ...
                    <div class="card mb-0">
                        <div class="flex justify-content-between mb-3">
                            <div>
                                ...
                                <div class="text-900 font-medium text-xl">Valor: <span class="text-green-500 font-medium">{{ new Intl.NumberFormat('en-US').format(investment) }}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-0">
                        <div class="flex justify-content-between mb-3">
                            <div>
                                ...
                                <div class="text-900 font-medium text-xl">Valor: <span class="text-green-500 font-medium">{{ new Intl.NumberFormat('en-US').format(loans) }}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-0">
                        <div class="flex justify-content-between mb-3">
                            <div>
                                ...
                                <div class="text-900 font-medium text-xl">Valor: <span class="text-green-500 font-medium">{{ new Intl.NumberFormat('en-US').format(gain) }}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-0">
                        <div class="flex justify-content-between mb-3">
                            <div>
                                ...
                                <div class="text-900 font-medium text-xl">Valor: <span class="text-green-500 font-medium">{{ new Intl.NumberFormat('en-US').format(current_balance) }}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
